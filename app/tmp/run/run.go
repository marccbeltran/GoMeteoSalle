...
import (
	...
	_ "github.com/marccbeltran/tfmMeteoSalle/app"
	controllers "github.com/marccbeltran/tfmMeteoSalle/app/controllers"
	_ "github.com/marccbeltran/tfmMeteoSalle/app/jobs"
	tests "github.com/marccbeltran/tfmMeteoSalle/tests"
...
func Register() {
	...
	revel.RegisterController((*controllers.Cities)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers.Prediction)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers.States)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers.Station)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*controllers.Stations)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
